...
class Inspecao(db.Model):
    ...
    # Relacionamento com a Ordem de Serviço do Apex Inspect
    ordem_servico_id = db.Column(db.Integer, db.ForeignKey('ordens_servico.id'), nullable=True)
    ordem_servico = db.relationship('OrdemServico', backref=db.backref('inspecoes', lazy='dynamic'))
    ...
    def to_dict(self):
        return {
            ...
            'ordem_servico_codigo': self.ordem_servico.codigo if self.ordem_servico else None,
